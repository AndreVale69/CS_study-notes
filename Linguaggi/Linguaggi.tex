...
{f:Int -> Int | x>3 => f(x) > x * (x+1)}\end{lstlisting}\:\newline
	...
	\end{equation*}
 	...
 	\begin{itemize}
 		...
 		\begin{figure}[!htp]
 			\centering
 			\includegraphics[width=.5\textwidth]{img/regola_assegnamento-1.pdf}
 		\end{figure}
 		
 		\item Per la semantica dinamica, è necessario valutare l'espressione:
 		\begin{figure}[!htp]
 			\centering
 			\includegraphics[width=.6\textwidth]{img/regola_assegnamento-2.pdf}
 		\end{figure}
 		...
 		\begin{figure}[!htp]
 			\centering
 			\includegraphics[width=.7\textwidth]{img/regola_assegnamento-3.pdf}
 		\end{figure}
 	\end{itemize}
 	...
 	\begin{itemize}
 		...
 		\begin{figure}[!htp]
 			\centering
 			\includegraphics[width=.5\textwidth]{img/imp_regole_condizionale-2.pdf}
 		\end{figure}
 		...
 		\begin{itemize}
 			...
 			\begin{figure}[!htp]
 				\centering
 				\includegraphics[width=\textwidth]{img/imp_regole_condizionale-3.pdf}
 			\end{figure}
 			
 			\item La quarta regola:
 			\begin{figure}[!htp]
 				\centering
 				\includegraphics[width=.8\textwidth]{img/imp_regole_condizionale-4.pdf}
 			\end{figure}
 			
 			\item La quinta regola:
 			\begin{figure}[!htp]
 				\centering
 				\includegraphics[width=.8\textwidth]{img/imp_regole_condizionale-5.pdf}
 			\end{figure}
 		\end{itemize}
 	\end{itemize}\newpage
 	...
 	\begin{itemize}
 		...
 		\begin{itemize}
 			...
 			\begin{figure}[!htp]
 				\centering
 				\includegraphics[width=.5\textwidth]{img/imp_regole-composizione-3.pdf}
 			\end{figure}\newpage
 			
 			\item Il comando nullo, elemento neutro della composizione:
 			\begin{figure}[!htp]
 				\centering
 				\includegraphics[width=.3\textwidth]{img/imp_regole-composizione-4.pdf}
 			\end{figure}
 		\end{itemize}
 		...
 		\begin{itemize}
 			...
 			\begin{figure}[!htp]
 				\centering
 				\includegraphics[width=.4\textwidth]{img/imp_regole-composizione-6.pdf}
 			\end{figure}
 			
 			\item La settimana regola:
 			\begin{figure}[!htp]
 				\centering
 				\includegraphics[width=.7\textwidth]{img/imp_regole-composizione-7.pdf}
 			\end{figure}
 			
 			\item L'ottava regola:
 			\begin{figure}[!htp]
 				\centering
 				\includegraphics[width=.7\textwidth]{img/imp_regole-composizione-8.pdf}
 			\end{figure}
 		\end{itemize}
 	\end{itemize}
 	...
 	\begin{itemize}
 		...
 		\begin{figure}[!htp]
 			\centering
 			\includegraphics[width=.7\textwidth]{img/regole_transitive-3_5.pdf}
 		\end{figure}
 		...
 		\begin{figure}[!htp]
 			\centering
 			\includegraphics[width=.7\textwidth]{img/regole_transitive-7_8.pdf}
 		\end{figure}
 	\end{itemize}
 	...
 	\begin{itemize}
 		...
 		\begin{figure}[!htp]
 			\centering
 			\includegraphics[width=.4\textwidth]{img/imp_regole-iterazione-5.pdf}
 		\end{figure}\newpage
 		...
 		\begin{itemize}
 			...
 			\begin{figure}[!htp]
 				\centering
 				\includegraphics[width=.8\textwidth]{img/imp_regole-iterazione-9.pdf}
 			\end{figure}
 			
 			\item La decima regola:
 			\begin{figure}[!htp]
 				\centering
 				\includegraphics[width=.7\textwidth]{img/imp_regole-iterazione-10.pdf}
 			\end{figure}
 		\end{itemize}
 	\end{itemize}
	...
	\end{boxdef}\newpage
 	...
 	\begin{itemize}
 		...
 		\begin{figure}[!htp]
 			\centering
 			\includegraphics[width=.7\textwidth]{img/imp_regole-blocchi-6.pdf}
 		\end{figure}
 		...
 		\begin{itemize}
 			...
 			\begin{figure}[!htp]
 				\centering
 				\includegraphics[width=.7\textwidth]{img/imp_regole-blocchi-11.pdf}
 			\end{figure}\newpage
 			...
 			\begin{figure}[!htp]
 				\centering
 				\includegraphics[width=.7\textwidth]{img/imp_regole-blocchi-12.pdf}
 			\end{figure}
 			
 			\item Regola tredici:
 			\begin{figure}[!htp]
 				\centering
 				\includegraphics[width=.7\textwidth]{img/imp_regole-blocchi-13.pdf}
 			\end{figure}
 		\end{itemize}
 	\end{itemize}
 	...
 	\begin{itemize}
 		...
 		\begin{figure}[!htp]
 			\centering
 			\includegraphics[width=.7\textwidth]{img/imp_regole-blocchi-11_12.pdf}
 		\end{figure}
 		
 		\item La regola tredici e dodici:
 		\begin{figure}[!htp]
 			\centering
 			\includegraphics[width=.7\textwidth]{img/imp_regole-blocchi-13_12.pdf}
 		\end{figure}
 	\end{itemize}

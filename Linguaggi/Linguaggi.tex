...
P:
	...
	\begin{itemize}
		...
		\item \textcolor{Red3}{\textbf{Regole di precedenza}} tra operatori (paragrafo \ref{regole di precedenza})
		
		\item \textcolor{Red3}{\textbf{Regole di associatività}} degli operatori (paragrafo \ref{regole di associatività})
	...
	\subsubsection{Regole di precedenza}\label{regole di precedenza}
	
	\subsubsection{Regole di associatività}\label{regole di associatività}
	
	\subsubsection{Valutazione delle espressioni}\label{valutazione delle espressioni}

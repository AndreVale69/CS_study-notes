...
{    
    public static void main(String args[])
    {
        ...
        if(args.length < 3)    {
            ...
            System.out.println("Sono stati trovati " + service1.calcolaPrimi(Integer.parseInt(args[1]), Integer.parseInt(args[2])) + " numeri primi");
        }
        else    {
            System.out.println("USAGE: java ClientREST tipofunzione op1 op2");
        }
...
class RESTAPI
{
    ...
    int calcolaPrimi(int val1, int val2)  {
        ...
        try 
        { 
            u = new URL("http://"+server+":8000/calcola-primi?param1="+val1+"&param2="+val2);
            System.out.println("URL aperto: " + u);
        }
        catch (MalformedURLException e) 
        {

...
int main ()
{
    ...
    do
    {
        ...
        if ((voto > 17) && (voto < 31))
        // Controllo se il voto è giusto o errato
        {
            if (voto > max)
            max = voto;
    ...
    /* Finché il voto è compreso tra 18 e 30, continuo il ciclo */
    
    if (contatore != 0)
    /* Se il voto era un valore di fine inserimento, 
       il programma non entrerà in questo ciclo per 
       stampare i max, min e med */
    {

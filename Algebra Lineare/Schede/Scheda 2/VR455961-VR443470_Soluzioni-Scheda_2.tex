...
\begin{document}
	...
	\begin{proof}[\textbf{Dimostrazione che i vettori sono un sistema di generatori}]
		Per dimostrare che $\mathscr{B} = \left\{w_{1}, w_{2}\right\}$ è un sistema di generatori, è necessario stabilire se per ogni $v = \left(v_{1}, v_{2}\right) \in \mathscr{B}$ esistono due scalari $a_{1}, a_{2} \in \mathbb{C}$ tali che:
		\begin{equation*}

...
\begin{document}
	...
	\begin{equation*}
		\begin{array}{rcl}
			\displaystyle\iint\limits_{D} \left(x+y\right)^{2} \:\mathrm{d}x\:\mathrm{d}y
			&=&
			\displaystyle\int_{\frac{\pi}{4}}^{\frac{\pi}{3}} \left(\int_{1}^{2} \left(\rho\cos\left(\theta\right)+\rho\sin\left(\theta\right)\right)^{2} \cdot \rho \:\mathrm{d}\rho\right) \:\mathrm{d}\theta
		\end{array}
	\end{equation*}

...
\begin{document}
	...
	\begin{itemize}
		...
		\item $\displaystyle\int \sin^{2}\left(x\right) \: \mathrm{d}x = \dfrac{1-\cos\left(2x\right)}{2} + c$

		\item $\displaystyle\int \cos\left(x\right) \: \mathrm{d}x = \sin\left(x\right) + c$
		
		\item $\displaystyle\int \cos^{2}\left(x\right) \: \mathrm{d}x = \dfrac{1+\cos\left(2x\right)}{2} + c$
	...
	\noindent
	Per ottenere le costanti $c_{1}$ e $c_{2}$ è necessario integrare le derivate appena trovare, per cui:
	\begin{equation*}
		\begin{array}{rcl}
			c_{1} &=& \displaystyle\int -\sin^{2}\left(x\right) \:\mathrm{d}x \\
			&\downarrow& \text{si utilizza l'integrale fondamentale } \displaystyle\int \sin^{2}\left(x\right) \: \mathrm{d}x = \dfrac{1-\cos\left(2x\right)}{2} + c \\
			&=& \displaystyle
		\end{array}
	\end{equation*}

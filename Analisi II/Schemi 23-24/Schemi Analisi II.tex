...
\begin{document}
	...
	\begin{itemize}
		...
		\end{equation*}
		Si chiama forma differenziale lineare (in $\mathbb{R}^{2}$) ed è un modo alternativo di esprimere il prodotto scalare $\overset{\rightarrow}{F} \cdot \mathrm{d}\overset{\rightarrow}{r}$, con:
		\begin{equation*}
		...
		\end{equation*}
		Si è quindi soliti scrivere l'integrale di linea di un campo vettoriale anche nella forma:
		\begin{equation*}
			\displaystyle\int_{\gamma} \omega
		\end{equation*}
	\end{itemize}\newpage

	\subsubsection{Conservativi}
	...
	%\subsubsection{Insiemi semplicemente connessi}

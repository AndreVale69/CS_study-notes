...
\begin{document}
	...
	\begin{itemize}
		...
		\end{equation*}
	\end{itemize}
	L'insieme $D$ non è aperto poiché $D \ne \mathring{D}$ ma neanche chiuso poiché $D = \overline{D}$.\newpage
	...
	\subsubsection{Esempi di grafico di funzioni a due variabili}\label{subsubsection: esempi di grafico di funzioni a due variabili}
	...
	\subsection{Continuità e limiti}\label{subsection: continuità e limiti}

	\subsubsection{Continuità}\label{subsubsection: continuità}

	\subsubsection{Limiti}\label{subsubsection: limiti}

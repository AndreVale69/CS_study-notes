...
\begin{document}
	...
	\begin{equation*}
		\begin{array}{rcl}
			...
			&\downarrow& \text{il logaritmo non può essere uguale a zero per definizione} \\
			&& \text{per cui, può essere minimo uguale a }1 \\
			\dfrac{2}{3}x^{3} + e &>& 1 \\
			\dfrac{2}{3}x^{3} &>& 1 - e \\
		...
		\end{array}
	\end{equation*}
	L'intervallo massimale ha un valore minimo, corrispondente al valore sotto radice, e un valore massimo uguale all'infinito:
	\begin{equation*}
	...
	\begin{flushleft}\label{exam: esame 10 luglio 2023 - Gruppo A - 3 esercizio (a)}
	...
	\begin{flushleft}\label{exam: esame 10 luglio 2023 - Gruppo A - 3 esercizio (b)}
	...
	\begin{flushleft}\label{exam: esame 10 luglio 2023 - Gruppo A - 4 esercizio (a)}
	...
	\begin{flushleft}\label{exam: esame 10 luglio 2023 - Gruppo A - 4 esercizio (b)}
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\begin{itemize}
				...
				\begin{enumerate}[label*=Ex. \arabic*), leftmargin = 4em]
					\item Variabili separabili e problema di Cauchy: pag.~\pageref{exam: esame 21 giugno 2023 - Gruppo A - 1 esercizio}
					\setcounter{enumi}{3}
					\item (\emph{b}) Parametrizzazione di una retta tangente e trovare l'equazione cartesiana: pag.\pageref{exam: esame 21 giugno 2023 - Gruppo A - 4 esercizio (b)}
				\end{enumerate}
			\end{itemize}
			...
			\begin{itemize}
				\item Gruppo A
				\begin{enumerate}[label*=Ex. \arabic*), leftmargin = 4em]
					\item Variabili separabili e problema di Cauchy: pag.~\pageref{exam: esame 10 luglio 2023 - Gruppo A - 1 esercizio}
					\item Metodo di somiglianza e problema di Cauchy: pag.~\pageref{exam: esame 10 luglio 2023 - Gruppo A - 2 esercizio}
					\item (\emph{a}) Dominio, insieme aperto o chiuso, limitato o illimitato, connesso o sconnesso: pag.~\pageref{exam: esame 10 luglio 2023 - Gruppo A - 3 esercizio (a)}
					\setcounter{enumi}{2}
					\item (\emph{b}) Derivata direzionale: pag.~\pageref{exam: esame 10 luglio 2023 - Gruppo A - 3 esercizio (b)}
					\item (\emph{a}) Limiti e continuità con differenziabilità: pag.~\pageref{exam: esame 10 luglio 2023 - Gruppo A - 4 esercizio (a)}
					\setcounter{enumi}{3}
					\item (\emph{b}) Calcolo della lunghezza di una curva piana: pag.~\pageref{exam: esame 10 luglio 2023 - Gruppo A - 4 esercizio (b)}
				\end{enumerate}
			\end{itemize}
			...
			\begin{itemize}
				\item Gruppo A
				\begin{enumerate}[label*=Ex. \arabic*), leftmargin = 4em]
					\item Variabili separabili e problema di Cauchy: pag.~\pageref{exam: esame 06 settembre 2023 - Gruppo A - 1 esercizio}
					\item Metodo di somiglianza e problema di Cauchy: pag.~\pageref{exam: esame 06 settembre 2023 - Gruppo A - 2 esercizio}
					\item (\emph{a}) Dominio, insieme aperto o chiuso, limitato o illimitato, connesso o sconnesso: pag.~\pageref{exam: esame 06 settembre 2023 - Gruppo A - 3 esercizio (a)}
					\setcounter{enumi}{2}
					\item (\emph{b}) Derivata direzionale e calcolo del valore massimo della derivata direzionale al variare del vettore $\overrightarrow{v}$: pag.~\pageref{exam: esame 06 settembre 2023 - Gruppo A - 3 esercizio (b)}
					\item (\emph{a}) Limiti e continuità: pag.~\pageref{exam: esame 06 settembre 2023 - Gruppo A - 4 esercizio (a)}
					\setcounter{enumi}{3}
					\item (\emph{b}) Parametrizzazione di una retta tangente e di una retta normale: pag.~\pageref{exam: esame 06 settembre 2023 - Gruppo A - 4 esercizio (b)}
				\end{enumerate}
			\end{itemize}
		\end{itemize}
		...
		\begin{itemize}
			...
			\begin{itemize}
				...
				\begin{enumerate}[label*=Ex. \arabic*), leftmargin = 4em]
					\setcounter{enumi}{3}
					\item (\emph{a}) Limiti e continuità: pag.~\pageref{exam: esame 01 marzo 2022 - Gruppo A - 4 esercizio (a)}
				\end{enumerate}
			\end{itemize}
		\end{itemize}
	\end{itemize}

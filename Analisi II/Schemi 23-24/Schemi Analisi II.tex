...
\begin{document}
	...
	\begin{itemize}
		\item Ridursi al problema di ricerca degli estremi in una variabile, ovvero \definition{parametrizzazione del vincolo};

		\item \definition{Metodo dei moltiplicatori di Lagrange}
	\end{itemize}
	...
	% Inserire i due esempi, magari inserendo prima una piccola "anteprima".

	\subsubsection{Metodo dei moltiplicatori di Lagrange}\label{subsubsection: metodo dei moltiplicatori di Lagrange}

	% Teoria, partendo dal teorema dal moltiplicatore di Lagrande (vedi slide)
	% continua con quello che c'è scritto sugli appunti arrivando fino alla fine.

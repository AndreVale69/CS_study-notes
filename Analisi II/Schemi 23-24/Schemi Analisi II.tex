...
\begin{document}
	...
	\begin{itemize}
		...
		\item A differenza dell'esempio precedente, in questo caso la $x$ non può essere qualsiasi valore poiché il $\sin$ è al denominatore. Per cui, la condizione d'esistenza è:
		\begin{equation*}
			\sin\left(x\right) > 0
		\end{equation*}

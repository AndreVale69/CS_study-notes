...
\begin{document}
	...
	\subsubsection{Esercizio retta tangente}\label{subsubsection: esercizio retta tangente}
	...
	\begin{equation*}
		r\left(s\right) = \gamma\left(t_{0}\right) s \gamma'\left(t_{0}\right) = \left(1,0,0\right) + s\left(1,1,1\right) = \left(1+s, s, s\right)
	\end{equation*}

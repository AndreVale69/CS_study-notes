...
\begin{document}
	...
	\begin{flushleft}\label{exam: esame 21 giugno 2023 - Gruppo A - 4 esercizio (b)}
		...
		\begin{itemize}
			...
			\begin{itemize}
				...
				\begin{itemize}
					...
					\item (Ex. 4 - \emph{b}) Parametrizzazione: pag.~\pageref{exam: esame 21 giugno 2023 - Gruppo A - 4 esercizio (b)}
				\end{itemize}
			\end{itemize}
			...
			\begin{itemize}
				\item Gruppo A
				\begin{itemize}
					\item (Ex. 1) Variabili separabili e problema di Cauchy: pag.~\pageref{exam: esame 10 luglio 2023 - Gruppo A - 1 esercizio}
					\item (Ex. 2) Metodo di somiglianza e problema di Cauchy: pag.~\pageref{exam: esame 10 luglio 2023 - Gruppo A - 2 esercizio}
					\item (Ex. 3 - \emph{a}) Dominio, insieme aperto o chiuso, limitato o illimitato, connesso o sconnesso: pag.~\pageref{exam: esame 10 luglio 2023 - Gruppo A - 3 esercizio (a)}
					\item (Ex. 3 - \emph{b}) Derivata direzionale con valore massimo: pag.~\pageref{exam: esame 10 luglio 2023 - Gruppo A - 3 esercizio (b)}
				\end{itemize}
			\end{itemize}

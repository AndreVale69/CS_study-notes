...
\begin{document}
	...
	\subsubsection{Verificare l'esistenza di limiti: Manipolazioni algebriche}\label{subsubsection: manipolazioni algebriche}
	...
	\subsubsection{Verificare l'esistenza di limiti: Maggiorazioni utili per risolvere limiti e Teorema del confronto (dei due carabinieri)}\label{subsubsection: maggiorazioni utili per risolvere limiti e Teorema del confronto (dei due carabinieri)}
	...
	\subsubsection{Verificare l'esistenza di limiti: Calcolo limiti in coordinate polari}\label{subsubsection: calcolo limiti in coordinate polari}

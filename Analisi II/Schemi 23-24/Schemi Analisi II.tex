...
\begin{document}
	...
	\subsubsection{Esempi}\label{subsubsection: esempi}
	...
	\subsubsection{Definizione su regioni non rettangolari}\label{subsubsection: definizione su regioni non rettangolari}

	\subsubsection{Altri esempi}\label{subsubsection: altri esempi}

	\subsubsection{Proprietà degli integrali doppi}\label{subsubsection: proprietà degli integrali doppi}

...
\begin{document}
	...
	\subsection{Classificazione dei punti stazionari}\label{subsection: ricerca massimi, minimi e punti di sella}
	...
	\noindent
	Nonostante la teoria possa sembrare complessa, la classificazione dei punti stazionari è piuttosto semplice grazie al \textbf{teorema delle derivate seconde} e alla famosa matrice Hessiana (eq. \ref{eq: matrice Hessiana}) e riportata qua di seguito per semplicità:
	\begin{equation*}
		H_{f}\left(x,y\right) = 
		\begin{pmatrix}
			f_{xx}\left(x,y\right) & f_{xy}\left(x,y\right) \\

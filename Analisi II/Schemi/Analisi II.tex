...
\begin{document}
	...
	\begin{gather*}
		\dfrac{y}{1 - y} = e^{kx} \cdot e^{c}; \hspace{2em}
		y = e^{c} \cdot e^{kx} \cdot \left(1 - y\right); \\
		y = e^{c} \cdot e^{kx} - e^{c} \cdot e^{kx} y; \hspace{2em}
		y\left(1 + e^{c} \cdot e^{kx}\right) = e^{c} \cdot e^{kx}; \\

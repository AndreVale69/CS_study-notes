...
%	\end{equation*}
	...
	\begin{equation*}
		\mathcal{L}\left(x,y,\lambda\right) = \left(4x^{2} + 9y^{2} - x^{2}y^{2}\right) - \lambda\left(x^{2} + 2y^{2} - 9\right)
	\end{equation*}
	...
	\begin{equation*}
		\begin{cases}
			\dfrac{\partial \mathcal{L}}{\partial x}\left(x,y,\lambda\right) = \\
			\\
			\dfrac{\partial \mathcal{L}}{\partial y}\left(x,y,\lambda\right) = \\
			\\
			\dfrac{\partial \mathcal{L}}{\partial \lambda}\left(x,y,\lambda\right) = 
		\end{cases}
	\end{equation*}
\end{document}
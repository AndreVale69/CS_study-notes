...
%	\end{equation*}
	...
	La risoluzione degli integrali prevede 3 tecniche:
	\begin{itemize}
		...
		\item Per fili (pagina~\pageref{par: per fili - calcolo integrale doppio})
	\end{itemize}
	...
	\begin{mdframed}
		...
		\begin{center}
			\includegraphics[width=.37\textwidth]{img/grafico-ex6-6.pdf}
		\end{center}
		...
		\begin{center}
			\includegraphics[width=.37\textwidth]{img/grafico-ex6-7.pdf}
		\end{center}
	...
	\newpage
	\subsubsection{Per fili - Calcolo integrale doppio}\label{par: per fili - calcolo integrale doppio}
\end{document}
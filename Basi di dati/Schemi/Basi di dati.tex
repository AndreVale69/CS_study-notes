...
ABORT;\end{lstlisting}\newpage
	...
	\subsubsection{Controllo di concorrenza - Introduzione}
...
COMMIT;\end{lstlisting}
	...
	Essendo impostato di \emph{default}, non necessita di essere specificato dopo il \textsf{BEGIN}. Con questo livello di isolamento:
	\begin{itemize}

...
xsi:schemaLocation="http://www.books.org BookStore.xsd">\end{lstlisting}
	...
	\subsubsection{Derivazione dei \textsf{complexType}}
...
<xsd:element name="name" minOccurs="int" maxOccurs="int"/>
	...
	Oppure, è possibile dichiarare un elemento nel seguente modo, sfruttando l'elemento \textsf{simpleType}:
	\begin{lstlisting}[language=XML]
<xsd:element name="name" minOccurs="int" maxOccurs="int"/>
	<xsd:simpleType>
	...
	\subsubsection{Formattazione rigida grazie a \textsf{simpleType} e alle espressioni regolari}\label{simpleType}
	...
	Le definizioni dei vari tipi si possono trovare al paragrafo~\ref{complexType} per quanto riguarda \textsf{complexType}, mentre al paragrafo~\ref{simpleType} per quanto riguarda \textsf{simpleType}.\newline
	...
	\subsection{Sostituzione di elementi}\label{sostituzione di elementi}
...
<xs:element name="navn" substitutionGroup="name"/>\end{lstlisting}

...
EXPLAIN SELECT * FROM Insegn WHERE id < 1000 AND nomeins LIKE 'Al%'\end{lstlisting}
	...
	\noindent
	\textsf{Bitmap Heap Scan ON Insegn (cost=18.40..134.62 ROWS=1...)}\newline
	\textsf{Recheck Cond: (id < 1000)}\newline
	\textsf{Filter: ((nomeins)::TEXT $\sim\sim$ 'Al\%'::TEXT)}\newline
	\textsf{-> Bitmap INDEX Scan ON i1 (cost=0.00..18.39 ROWS=815 width=0)}\newline
	\textsf{\phantom{-> }INDEX Cond: (id < 1000)}
	\begin{enumerate}
...
EXPLAIN SELECT * FROM Insegn WHERE id < 1000 AND nomeins LIKE 'Al%'\end{lstlisting}
	...
	\noindent
	\textsf{Bitmap Heap Scan ON Insegn (cost=15.30..22.58 ROWS=4 width=63)}\newline
	\textsf{Recheck Cond: (id < 1000)}\newline
	\textsf{Filter: ((nomeins)::TEXT $\sim\sim$ 'Al\%'::TEXT)}\newline
	\textsf{-> BitmapAnd (cost=15.30..15.30 ROWS=4 width=0)}\newline
	\textsf{-> Bitmap INDEX Scan ON nomeidx (cost=0..2.65 ROWS=37 width=0)}\newline
	\textsf{\phantom{-> }INDEX Cond: (((nomeins)::TEXT $\sim$>=$\sim$ 'Al'::TEXT) AND}\newline
	\textsf{\phantom{-> INDEX Cond: (}((nomeins)::TEXT $\sim$<$\sim$ 'Am'::TEXT))}\newline
	\textsf{-> Bitmap INDEX Scan ON i1 (cost=0.00..12.40 ROWS=815 width=0)}\newline
	\textsf{\phantom{-> }INDEX Cond: (id < 1000)}
	\begin{itemize}
...
EXPLAIN SELECT * FROM Insegn WHERE id < 1000 OR nomeins LIKE 'Al%'\end{lstlisting}
	...
	\noindent
	\textsf{Bitmap Heap Scan ON Insegn (cost=15.47..132.25 ROWS=850 width=63)}\newline
	\textsf{Recheck Cond: ((id < 1000) OR ((nomeins)::TEXT $\sim\sim$ 'Al\%'::TEXT))}\newline
	\textsf{Filter: ((id < 1000) OR ((nomeins)::TEXT $\sim\sim$ 'Al\%'::TEXT))}\newline
	\textsf{-> BitmapOr (cost=15.47..15.47 ROWS=852 width=0)}\newline
	\textsf{-> Bitmap INDEX Scan ON i1 (cost=0.00..12.40 ROWS=815 width=0)}\newline
	\textsf{\phantom{-> }INDEX Cond: (id < 1000)}\newline
	\textsf{-> Bitmap INDEX Scan ON nomeidx (cost=0.00..2.65 ROWS=37 width=0)}\newline
	\textsf{\phantom{-> }INDEX Cond: (((nomeins)::TEXT $\sim$>=$\sim$ 'Al'::TEXT) AND}\newline
	\textsf{\phantom{-> INDEX Cond: (}((nomeins)::TEXT $\sim$<$\sim$ 'Am'::TEXT))}
	\begin{itemize}
...
EXPLAIN SELECT * FROM Insegn WHERE id < 1000 AND nomeins LIKE 'Al%'\end{lstlisting}
	...
	\noindent
	\textsf{Bitmap Heap Scan ON Insegn (cost=12.40..128.62 ROWS=1 width=63)}\newline
	\textsf{Recheck Cond: (id < 1000)}\newline
	\textsf{Filter: ((nomeins)::TEXT $\sim\sim$ 'Al\%'::TEXT)}\newline
	\textsf{-> Bitmap INDEX Scan ON i1 (cost=0.00..12.40 ROWS=815 width=0)}\newline
	\textsf{\phantom{-> }INDEX Cond: (id < 1000)}\newline
